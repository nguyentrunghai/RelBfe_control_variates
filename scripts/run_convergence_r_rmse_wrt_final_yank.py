...
from _yank_algdock import load_scores
...
parser.add_argument("--final_results_dir", type=str,default="Relative_FE_Est")

parser.add_argument("--yank_results_file", type=str, default="yank_results.dat")
...
def _r_rmse_one_ref_ligand_a_random_sample_of_snapshot_with_cv(algdock_score_dir, target_ligands,
                                                                  ref_ligand, ref_ligands,
                                                                  FF, weights, yank_interaction_energies,
                                                                  sample_size, final_rel_fes, yank_abs_fes,
                                                                  replace):
    ...
    fes = {}
    for ligand in target_ligands:
        _, _, _, _, fe = relative_bfe_control_variate(rand_snapshots, algdock_score_dir,
                                                                       ligand, ref_ligand,
...
def _bootstrap_r_rmse_one_ref_ligand(algdock_score_dir, target_ligands,
    ...
    if method == "without_cv":
        ...
        _r_rmse_one_ref_ligand_a_random_sample_of_snapshot = _r_rmse_one_ref_ligand_a_random_sample_of_snapshot_with_cv
...
assert args.method in ["without_cv", "with_cv"], "unrecognized method: " + args.method
