...
from _yank_algdock import SIX_REF_SYSTEMS as YANK_SYSTEMS
from _yank_algdock import snapshot_indices_for_algdock
...
def load_mbar_weights():
    ...
    selected_snapshots_per_system = snapshot_indices_for_algdock(nframes_per_state=NR_YANK_SNAPSHOTS_PER_SYSTEM)
